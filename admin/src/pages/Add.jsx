    ...
    <form onSubmit={onSubmitHandler} className='pl-8'>
      <div className='flex flex-col gap-y-2 medium-15'>
        ...
        <div>
          ...
          <textarea onChange={(e) => setDescription(e.target.value)} value={description} rows={5} type="text" placeholder='Write here..' className='px-3 py-1.5 ring-1 ring-slate-900/10 rounded bg-white mt-1 w-[333px] sm:w-full' />
        </div>
        <div>
